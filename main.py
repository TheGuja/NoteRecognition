...
if __name__ == "__main__":
    filepath_to_model = input("What model do you want to use? (Input file path to model): ")
    filepath_to_audio = input("Input your audio: ")
    filepath_to_sheetmusic = input("Input your sheetmusic: ")
    ...
    extract_audio(filepath_to_sheetmusic, filepath_to_audio)
    ...
    model = pitchClassification(filepath_to_model)
