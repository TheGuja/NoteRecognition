...
for element in score.flatten().notes:
    if element.isNote:  # If the element is a single note
        ...
        timestamps.append((note_name, start_time, start_time * beats_per_second))
...
for note, time, seconds in timestamps:
    print(f"Note: {note}, Time: {time} quarter notes, Time: {seconds} seconds")